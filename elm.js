...
var $author$project$Main$view = function (model) {
	var timeStr = function () {
		var z = model.zone;
		var t = model.time;
		var second = A2($elm$time$Time$toSecond, z, t);
		var minute = A2($elm$time$Time$toMinute, z, t);
		var hour = A2($elm$time$Time$toHour, z, t);
		return $elm$core$String$fromInt(hour) + (':' + (A3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Date: ' + dateStr)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Time: ' + timeStr)
					])),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('https://www.toastmasters.org/'),
						$elm$html$Html$Attributes$target('_blank')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('The Toastmasters')
					])),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('https://www.wisc.edu/'),
						$elm$html$Html$Attributes$target('_blank')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('University of Wisconsin')
					]))
			]));
};
